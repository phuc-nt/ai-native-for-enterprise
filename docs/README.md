...
| 04 | [`04-organization-f-ai-adoption/`](04-organization-f-ai-adoption/) | Mục tiêu 1, một tổ chức cụ thể | Cho một task thật của team DevOps: bối cảnh và định hướng, role và tool, hợp nhất guide sẵn có vào MK, thứ tự việc cho ba bên, cách rollout | Năm bản định hướng xong |
...
5. Khi đem đi đề xuất cho một tổ chức đã chọn Rovo và Kiro: [nhóm 04](04-organization-f-ai-adoption/README.md), định hướng, bảng role và tool, cách hợp nhất guide sẵn có vào MK, thứ tự việc cho ba bên.
