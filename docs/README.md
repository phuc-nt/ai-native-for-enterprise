...
5. Khi mở rộng sang tri thức dự án (Jira, Confluence, Slack, spec, biên bản họp): nhóm 01, bắt đầu từ [playbook từng nguồn](01-ai-ready-enterprise/engineering/09-data-source-playbook.md).
...
| Bạn là | Đọc |
|---|---|
| Lãnh đạo, người duyệt ngân sách | Nhóm 01 `leadership/`, rồi Portfolio mục 1 và 10; nếu khách hàng yêu cầu Kiro, thêm [Kiro + MK Kit](02-ai-in-sdlc/04-kiro-mk-kit-guide.md) phần A |
| Tech lead, PM kỹ thuật | Nhóm 02 tài liệu 01 và 04, nhóm 01 `leadership/` rồi `engineering/` 01, 09, 03, 04; người sở hữu kit đọc thêm nhóm 02 tài liệu 05 |
