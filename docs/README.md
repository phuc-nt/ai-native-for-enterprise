...
| Tech lead, PM kỹ thuật | Nhóm 2 tài liệu 01 và 04, nhóm 3 `leadership/` rồi `engineering/` 01, 09, 03, 04 |
| Kỹ sư sắp dùng bộ kit | Nhóm 2 theo thứ tự 01, 02, 03; dự án dùng Kiro đọc thêm 05 |
