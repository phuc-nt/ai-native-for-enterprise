...
| **Kiro** | IDE + CLI của AWS, spec-driven, Powers, xác thực IAM Identity Center | Khi khách hàng chuẩn hoá trên AWS và yêu cầu Kiro | Dự án sắp tới; bộ MK đã có bản Kiro chạy được trên CLI 2.21 (engine v2), xem [Kiro + MK Kit: Engineering Guide](../../02-ai-toolkit/05-kiro-mk-kit-engineering-guide.md) |
